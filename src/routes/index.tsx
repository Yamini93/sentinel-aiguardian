...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Sentinel AI — Cybersecurity Threat Intelligence"
      },
      {
        name: "description",
        content:
          "Sentinel AI detects deepfakes, voice clones, and fraud attempts."
      }
    ]
  })
});
          ...
          <>
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <RiskMeter
                ...
                label="Scam / Fraud Risk"
              />

              <RiskMeter
                score={result.deepfakeScore}
                label="Deepfake Suspicion"
              />
